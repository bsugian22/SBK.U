...
import Signfind from '../dialogs/Signfind'
         ...
         <div class="sign-in flex-inherit flex-column justify-content-center justify-content-center-inherit">
            ...
            <div class="input margin-bottom-50">
               <form class="frm-sign-in widthp-80" onSubmit={onLogin}>
                  <input class="widthp-100 height-40 color-white margin-bottom-5 background-transparent-b-15 padding-horizontal-10" placeholder="아이디를 입력하세요" type="text" name="username" />
                  <input
                     ...
                     name="password"
                  />
                  <button type="submit" class="widthp-100 height-40 btn-0 background-green color-white">
                     로그인
                  </button>
               </form>
            </div>
            <div class="join flex-column margin-bottom-70">
               ...
               <div class="margin-top-10">
                  <button type="button" class="background-transparent color-white font-size-12" onClick={SignupDialog}>
                     회원가입
                  </button>
               </div>
            </div>
            <div class="lost flex-column margin-bottom-20">
               <div class="color-grey font-size-11">
                  비밀번호가 기억나지 않나요?
                  <button class="background-transparent find-password margin-left-5 color-white font-size-11" onClick={SignfindDialog}>
                     비밀번호찾기
                  </button>
               </div>
            </div>
