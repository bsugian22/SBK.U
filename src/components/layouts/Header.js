...
const Header = (props) => {
  ...
  return (
    <Fragment>
      <div
        class="mobile-header-quick border-bottom padding-10"
        id="swiper_category_menu"
      >
      ...
      <div class="header-utility border-bottom height-60 flex color-grey justify-content-center-inherit padding-15 align-items-center-inherit">
        ...
        <button
          ...
          class={
            context.state.searchBar
              ? "mobile-utility-search margin-right-15 green"
              : "mobile-utility-search margin-right-15"
          }
          onClick={() => {
        ...
        <div class="header-utility-helpdesk flex">
          <button
            class="background-transparent color-grey padding-5 margin-right-5"
            onClick={toggleDarkmode}
          >
            {preferences.darkmode ? (
              <i class="fas fa-moon margin-0 color-yellow"></i>
            ) : (
              <i class="fas fa-moon margin-0"></i>
            )}
          </button>
      ...
      >
        <div class="flex grow-2 padding-horizontal-15 height-40">
          <input
            type="text"
            name="q"
            placeholder="찾으시는 팀 또는 리그명을 입력해주세요."
          />
          <button
            type="button"
            class="color-red"
