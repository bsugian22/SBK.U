...
const Outlogin = (props) => {
   const { user, setUser, setAccessToken, setLogout } = props
      ...
      return (
         <div class="header-account flex border-top border-bottom flex-row flex-inherit height-50">
            ...
            <div class="login-wrap flex-row grow-2 justify-content-end align-items-center padding-10">
               <button type="button" class="background-transparent color-green sign-in" onClick={SignInDialog}>
                  로그인
               </button>
               <span class="color-grey mx-5">OR</span>
               <button type="button" class="background-transparent color-white sign-up" onClick={SignUpDialog}>
                  신규회원가입
               </button>
            </div>
         </div>
